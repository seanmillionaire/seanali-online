(function(){
  ...
  function restart(){localStorage.removeItem(stateKey);localStorage.removeItem(resultKey);location.href='/abundance-portal/quiz/';}
  ...
  if(document.body.dataset.portalPage==='quiz'){
    ...
    function render(){
      if(state.step>=total){
        ...
        location.href='/abundance-portal/results/?r='+data.results[key].slug;
        return;
      }
  ...
  if(document.body.dataset.portalPage==='result'){
    ...
    $('.ap-main-cta').href='/abundance-portal/reset/?r='+r.slug;
