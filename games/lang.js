(() => {
  ...
  const esToEn = {
    ...
    'Comida Natural':'Natural Food','Aprende qué tienen los alimentos naturales y desbloquea ideas de comidas simples.':'Learn what natural foods have and unlock simple meal ideas.',
    ...
    'Inicio':'Home','Juegos':'Games','Más juegos':'More games','Money':'Money','Food':'Food','Math Race':'Math Race','Beats':'Beats','Spanish':'Spanish','Quiz':'Quiz','Animals':'Animals','Music':'Music','Rhythm':'Rhythm','Sound':'Sound','Mindset':'Mindset','Health':'Health','Cars':'Cars','Math':'Math','Counting':'Counting',
