(() => {
  ...
  const colors = [
    ['#ff62b7','#ffd7ef','🪞'], ['#ff3b30','#ffe0d8','🏎️'], ['#7d4cff','#ece3ff','🧠'], ['#00d4ff','#dff8ff','🌎'], ['#34d17a','#e2ffe9','🥑'], ['#ffc83d','#fff6c7','💰'], ['#9b7cff','#efe7ff','💎'], ['#0ba85f','#d9fff0','🌿'], ['#ff8a00','#fff0d5','🥁'], ['#8f7cff','#f4f0ff','🎹'], ['#ffcc00','#fff9d4','💛'], ['#00a7ff','#e2f5ff','🌀']
  ];
  const cardColor = {
    '/games/piano/': ['#8f7cff','#f4f0ff','🎹']
  };
  ...
  function setupMap() {
    ...
    [...grid.querySelectorAll('.card[href]')].forEach((card, i) => {
      ...
      const cfg = cardColor[href] || colors[i % colors.length];
